  ...
  return (
    <>
      <section className="about " id="about">
        <div className="container grid grid-cols-1 lg:grid-cols-2 mx-auto gap-14 lg:gap-40 mt-6 lg:mt-32 p-2">
          <div className="banner">
            <div className="top ">
              <h1 className="heading text-3xl font-bold mb-4 ">ABOUT US</h1>
              <p className="my-3 ">The only thing we're serious about good food.</p>
            </div>
          ...
          <div className="banner ">
            <img className="rounded-2xl" src={HeroImg} alt="about" />
          </div>
        </div>
      </section>
    </>
